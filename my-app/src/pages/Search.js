                            ...
                            <ListItem key={book._id} style={{ margin: '10px' }}>
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        {book.image ?
                                            <button type="button" className="btn btn-success btn-lg" onClick={() => handleSave({ ...book, image: book.image.thumbnail })}  data-target="#bookSelect">SAVE</button> :
                                            <button type="button" className="btn btn-success btn-lg" onClick={() => handleSave({ ...book, image: null  })}  data-target="#bookSelect">SAVE</button>
                                        }
